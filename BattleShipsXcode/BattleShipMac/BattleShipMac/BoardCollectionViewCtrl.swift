...
class BoardCollectionViewCtrl: UICollectionViewController {
    ...
    func afterInitModel(_ viewModel: BattleViewModel, imThePlayer: Bool) {
    ...
    func newGameDialog(_ msg: String? = .none, hasACancelButton: Bool = false) {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath as IndexPath) as! BoardCollectionViewCell
   ...
   func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAtIndexPath indexPath: IndexPath) -> CGSize {
    ...
    override func collectionView(_ collectionView: UICollectionView, shouldSelectItemAtIndexPath indexPath: IndexPath) -> Bool {
        if imThePlayer && viewModel.gameStatus == .notStarted {
            newGameDialog()
        } else if imThePlayer {
            newGameDialog("Do you want to start again", hasACancelButton: true)
        } else {
